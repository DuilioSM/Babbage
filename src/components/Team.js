...
function Team() {
  return (
    <div className='flex flex-col items-center h-fit px-5'>
        <h3 className='mt-16 text-3xl font-extrabold leading-tight tracking-wider text-center md:text-5xl'>Nuestro <span className='text-3xl font-extrabold leading-tight tracking-wider text-highRed md:text-5xl'>equipo</span> para tu empresa</h3>
        <p className='text-center  text-sm text-grayText p-6 leading-normal	tracking-widest md:w-6/12'>Sabemos la importancia que tiene el software para las pymes, por ello buscamos la mejor experiencia para nuestros clientes</p>
        <div className='pt-6 pb-20  grid gap-8 grid-cols-1 md:grid-cols-2 md:grid-rows-2 '>
