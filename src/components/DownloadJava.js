...
function DownloadJava() {
  ...
  return (
    <div className="flex flex-col bg-blueGray py-16 items-center">
      ...
      >
        Es una solución de TI para aquellos que tienen acceso a alguna
        computadora conectada a la base de datos de la UTJ.
      </p>
      <a
        ref={(el) => {
          buttonItem = el;
        ...
        href="https://6239385564114e00085eafa6--gallant-wiles-2e012f.netlify.app/"
      >
